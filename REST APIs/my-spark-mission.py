...
#MISSION: FILL IN THE REQUESTED DETAILS.  Variables were set to None previously.
ACCESS_TOKEN 	= "NWNlY2YyZjYtMTllOC00MjQyLTlhNWMtOTg0OTFmM2MyOWU3MTA3YmY4NWYtMzEw" #Replace None with your access token. Shroud with quotes.
ROOM_NAME		= "Mission Test Room #2" #Replace None with the name of the room to be created. Shroud with quotes.
YOUR_MESSAGE 	= "I am a robot.  Beep Boop.  OK" #Replace None with the message that you will post to the room. Shroud with quotes.
...
#My Stuff.  Set headers and call findRoom for validation.
#my_header = setHeaders()
#my_room = findRoom(my_header,"Meeting Test")
#print(my_room)
#print()
...
#My stuff.  Set headers and call createRoom function for validation.  First with room that doesn't exist.  Then with room that does.
#my_header = setHeaders()
#my_room = createRoom(my_header,"Mission Test Room #1")
#print(my_room)
#print()
#my_dup_room = createRoom(my_header,"Room for Duplicate Testing")
#print(my_dup_room)
#print()
...
def getRoomInfo(the_header,roomId):
    ...
    print("Room " + resp["title"] + " was last used on " + resp["lastActivity"])

#My Stuff.  Set headers and call getRoomInfo function for validation.
#my_header = setHeaders()
#room_deets = getRoomInfo(my_header,"Y2lzY29zcGFyazovL3VzL1JPT00vYzA4NDc1YjAtMmI5NC0xMWU3LTg0ZmUtYzkyNzEyYTY3Njdk")
